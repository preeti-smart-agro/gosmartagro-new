...
window.onload = function(e) {
    ...
    var faqData = JSON.parse(
        '{"data":{"service":[{"html":"service.html","name":"Does engaging in the farm management service affect my ownership or title in any way?","description":"No! SmartAgro is merely a service provider that acts as your agent and conducts end-to-end farming services on your land. You can be rest assured that your title will remain as it is."},{"html":"service.html","name":"How will I be charged for the services provided?","description":"The activities and their expenses carried out on your farm will be pre-approved by you. Over and above this, SmartAgro will charge you a reasonable management fee for the services provided. The pricing structure varies from project to project and we believe in customising it as per the customer and his requirements. "},{"html":"service.html","name":"Why just organic and why not a traditional farming method? I’ve heard organic farming does not provide a good yield.","description":"<p >Contrary to popular belief, organic farming if done scientifically, can substantially increase the yield of the land.</p><p>SmartAgro’s expert team ensures that we get the best of both worlds - chemical-free crops and a financially profitable yield. </p>"}]}}'
    );
