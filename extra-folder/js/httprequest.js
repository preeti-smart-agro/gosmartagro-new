$(function () {
  ...
  try {
    window.onload = function () {
      try {
        ...
        if (
          href.endsWith("projects.html") ||
          href.endsWith("farmland-management-service.html") ||
          href.endsWith("leasing.html")
        ) {
          setTimeout(function () {
            var isCustomerInfoCapture = localStorage.getItem(
              "captureCustomerInfo"
            );
            if (isCustomerInfoCapture === null) {
              isCustomerInfoCapture = localStorage.setItem(
                "captureCustomerInfo",
                false
              );
              isCustomerInfoCapture = sessionStorage.getItem(
                "captureCustomerInfo"
              );
            }
            if (isCustomerInfoCapture !== null) {
              if (isCustomerInfoCapture === "false") {
                var elementId = document.getElementById("id-customer-info");
      ...
      if (storedDate === null) {
        storedDate = sessionStorage.getItem("storedDate");
      }
      ...
      if (storedDate === null) {
        ...
        if (new Date(currentDate) > new Date(storedDate)) {
          ...
          sessionStorage.setItem("storedDate", new Date().toLocaleDateString());
          localStorage.setItem("captureCustomerInfo", false);
          this.sessionStorage.setItem("captureCustomerInfo", false);
          showPopUp();
        } else {
          localStorage.setItem("storedDate", new Date().toLocaleDateString());
          sessionStorage.setItem("storedDate", new Date().toLocaleDateString());
  ...
  try {
    ...
    function scrollFunction() {
      ...
      if (document.documentElement.scrollTop >= 100) {
        relativeSmartagroSolution();
      } else {
        fixedSmartagroSolution();
      }
    }

    function fixedSmartagroSolution() {
      var smartagroSolutionButton = document.getElementById("pop-up-blk");
      smartagroSolutionButton.style.top = "0";
    }

    function relativeSmartagroSolution() {
      var smartagroSolutionButton = document.getElementById("pop-up-blk");
      smartagroSolutionButton.style.top = "unset";
      smartagroSolutionButton.style.bottom = "95px";
    }
  } catch (error) {}
  try {
  ...
  $(".mobile").mouseenter(function () {
    ...
    if (isMobile[0] !== "Mobi") {
      ...
      $(".visible").toggleClass("invisible");
      if (
        document.getElementById("mobile").value === undefined ||
        document.getElementById("mobile").value === ""
      ) {
  ...
  $("#servicesmobile").mouseenter(function () {
    ...
    if (
      document.getElementById("servicesmobile").value === "" ||
      document.getElementById("servicesmobile").value === undefined
    ) {
  ...
  $(".pr-we-connect-submit").click(function () {
    ...
    sessionStorage.setItem("isProjectBrowcherDownloaded", false);
    postRequest(
      "https://www.eternohousing.com/v1/services/gosmartagro/notification",
      "pr-contactForm",
      "Thank you for contacting us, Our team will get back to you within 24 Hours! Our friendly support team is available to help you, call on 9110223393",
  ...
  $(".sr-we-connect-submit").click(function () {
    ...
    localStorage.setItem("captureCustomerInfo", true);
    sessionStorage.setItem("captureCustomerInfo", true);
    sessionStorage.setItem("isServiceBrowcherDownloaded", false);
    postRequest(
      "https://www.eternohousing.com/v1/services/gosmartagro/notification",
      "sr-contactForm",
      "Thank you for contacting us, Our team will get back to you within 24 Hours! Our friendly support team is available to help you, call on 9110223393",
    ...
    if (document.getElementById("enq-moblnumber").value.length === 10) {
      ...
      if (val === "I have my own agricultural land / I own farmland") {
        ...
        if (document.getElementById("readytoinvest").value !== "---Select---") {
          if (
            document.getElementById("freesitevisit").value !== "---Select---"
          ) {
            postRequest(
              "https://www.eternohousing.com/v1/services/gosmartagro/notification",
              "enquiryform",
  ...
  function showPopUp() {
    var idCustomerInfo = document.getElementById("id-customer-info");
    if (idCustomerInfo.classList.contains("in-visible")) {
  ...
  function checkDevice() {
    if (isMobile[0] === "Mobi") {
      ...
      try {
        var popUpBlk = document.getElementById("pop-up-blk");
        popUpBlk.classList.add("mbl-pop-up-blk");
        popUpBlk.classList.remove("pop-up-blk");
      } catch (error) {
        console.log(error);
      }
      var domElement = document.getElementById("video-tag-player");
      domElement.classList.add("in-visible");

      var domSocial = document.getElementById("social-icons");
      domSocial.classList.add("invisible");
    } else {
      try {
        document
          .getElementById("contact-numbers")
          .classList.add("align-to-right");
      } catch (error) {}
      var domElement = document.getElementById("video-tag-player");
      domElement.classList.remove("in-visible");

      var domSocial = document.getElementById("social-icons");
      domSocial.classList.remove("invisible");
      try {
        ...
        stopButton.addEventListener(
          ...
          function (e) {
            e.preventDefault();
            var iframes = document.getElementById("video");
            try {
              var src = iframes.getAttribute("src");
              iframes.setAttribute("src", src + ";&mute=1");
            } catch (error) {}
            document
              .getElementById("video-tag-player")
  ...
  function postRequest(url, formid, _message, code) {
    ...
    xhr.onreadystatechange = function () {
      if (this.readyState === XMLHttpRequest.DONE && this.status === 200) {
        ...
        if (json.status === 0) {
          var isProjectBrowcherDownloaded = sessionStorage.getItem(
            "isProjectBrowcherDownloaded"
          );
          if (isProjectBrowcherDownloaded === "false") {
            try {
          ...
          var isServiceBrowcherDownloaded = sessionStorage.getItem(
            "isServiceBrowcherDownloaded",
            "_blank"
          );
          if (isServiceBrowcherDownloaded === "false") {
            try {
  ...
  function getFormObj(formId, code, subject) {
    var formObj = {
      name: "",
      mobile: "",
      email: "",
    ...
    if (formId === "enquiryform") {
      try {
        formObj["readytoinvest"] = document.getElementById(
          "readytoinvest"
        ).value;
        formObj["freesitevisit"] = document.getElementById(
          "freesitevisit"
        ).value;
      } catch (error) {}
      try {
        ...
        if (val === "I have my own agricultural land / I own farmland") {
          ...
          val === "I want to buy agricultural land / I want to invest"
        ) {
          objValue = "Product";
        }
      } catch (error) {}
    ...
    if (formId === "pr-contactForm") {
      ...
      if (
        readytoinvest.value !== undefined &&
        !readytoinvest.value.includes("Select")
      ) {
      ...
      if (
        freesitevisit.value !== undefined &&
        !freesitevisit.value.includes("Select")
      ) {
    ...
    try {
      ...
      if (currentUrl.indexOf("thank-you") != -1) {
        ...
        if (oldUrl != null) {
          ...
          window.location.href = "https://gosmartagro.com/";
        }
      }
    } catch (error) {}
  }, 6000);
